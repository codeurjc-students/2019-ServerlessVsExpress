...
const BASE_URL_API_CONNECTION = Config.BASE_URL_API_CONNECTION;
...
export const saveConnectionInfo = (email) => {
    const result = new Promise((resolve, reject) => {
        axios.post(`${BASE_URL_API_CONNECTION}/addConnectionInfo`, {email})
            .then((res) => resolve(res))
            .catch((err) => reject(err))
    });
